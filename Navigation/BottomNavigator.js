      ...
      return (
        <NavigationContainer>
          ...
          style : {
            ...
            <BottomTabs.Screen name="Home" component={this.HomeStack} options={{
          tabBarLabel: 'Home',
          tabBarIcon: ({ color }) => (
        ...
        />
            <BottomTabs.Screen name="Categories" component={this.CategoriesStack} options={{
          tabBarLabel: 'Categories',
          tabBarIcon: ({ color }) => (
            <FontAwesome name="th-list" color={color} size={22} />
          ),
        }} />
            <BottomTabs.Screen name="Favorites" component={this.FavStack} options={{
          tabBarLabel: 'Favorites',
          tabBarIcon: ({ color }) => (
            <FontAwesome name="heart" color={color} size={22} />
          ),
        }} />
            <BottomTabs.Screen name="About" component={this.AboutStack} options={{
          tabBarLabel: 'About',
          tabBarIcon: ({ color }) => (
            <FontAwesome5 name="info-circle" color={color} size={22} />
          ),
        }} />
           <BottomTabs.Screen name="Rating" component={this.RatingStack} options={{
          tabBarLabel: 'Rating',
          tabBarIcon: ({ color }) => (
